...
load_sprite(4, (unsigned int) fighter_stand_0, 16, 1);
load_sprite(5, (unsigned int) fighter_stand_1, 16, 1);
...
//cargamos el sprite vacío para la piña	
...
load_sprite(3, (unsigned int) empty_sprite, 16, 0);
	...
	if(walk1>0 && walk1<12){
		...
		load_sprite(0, (unsigned int) fighter_walk_0, 16, 0);
		load_sprite(1, (unsigned int) fighter_walk_1, 16, 0);

	}else if(stand1>0 && stand1<12){
		load_sprite(0, (unsigned int) fighter_stand_0, 16, 0);
		load_sprite(1, (unsigned int) fighter_stand_1, 16, 0);
	}else{
		load_sprite(0, (unsigned int) fighter_stand_2, 16, 0);
		load_sprite(1, (unsigned int) fighter_stand_3, 16, 0);
	...
	switch(player1_action)
	{
		case PLAYER_LP_CROUCH:
			...
			load_sprite(1, (unsigned int) fighter_lp0_crouch, 16, 0);
			load_sprite(3, (unsigned int) fighter_lp1_crouch, 16, 0);
			break;
		case PLAYER_LP:
			//load_sprite(0, (unsigned int) empty_sprite, 16, 0);		
			load_sprite(0, (unsigned int) fighter_lp0, 16, 0);
			load_sprite(2, (unsigned int) fighter_lp1_crouch, 16, 0);
			break;
		case PLAYER_LK_CROUCH:
			load_sprite(0, (unsigned int) empty_sprite, 16, 0);		
			load_sprite(1, (unsigned int) fighter_lk0_crouch, 16, 0);
			load_sprite(3, (unsigned int) fighter_lk1_crouch, 16, 0);
			break;
		case PLAYER_LK:
			//load_sprite(0, (unsigned int) empty_sprite, 16, 0);		
			load_sprite(1, (unsigned int) fighter_lk0, 16, 0);
			load_sprite(3, (unsigned int) fighter_lk1, 16, 0);
			break;
		case PLAYER_CROUCH:
			load_sprite(0, (unsigned int) empty_sprite, 16, 0);
			load_sprite(1, (unsigned int) fighter_crouch, 16, 0);
			break;
		case PLAYER_JUMP:
			
			 if(player1_frame<20){ //subida
				pos1y=pos1y-4;
				player1_frame++;	
			}else if(player1_frame>=20){ //fin del salto, iniciamos la caida
				pos1y=pos1y+4;
				player1_frame++;
			} 
			...
			load_sprite(0, (unsigned int) fighter_jp0, 16, 0);
			load_sprite(1, (unsigned int) fighter_jp1, 16, 0);
			break;

	}
	/*if(player1_action == PLAYER_LP_CROUCH){
		load_sprite(0, (unsigned int) empty_sprite, 16, 0);		
		load_sprite(1, (unsigned int) fighter_lp0_crouch, 16, 0);
		
	}else if(player1_action == PLAYER_CROUCH){
		load_sprite(0, (unsigned int) empty_sprite, 16, 0);
		load_sprite(1, (unsigned int) fighter_crouch, 16, 0);
	}*/
	...
	if(player1_frame==0) //si no está corriendo una animación
	{
